...
import com.upcn.ssoc22.repository.ClienteRepository;
...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(DEFAULT_NOMBRE).socio(DEFAULT_SOCIO).suministro(DEFAULT_SUMINISTRO).dni(DEFAULT_DNI);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(UPDATED_NOMBRE).socio(UPDATED_SOCIO).suministro(UPDATED_SUMINISTRO).dni(UPDATED_DNI);
        return cliente;
    }
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getSocio()).isEqualTo(DEFAULT_SOCIO);
        assertThat(testCliente.getSuministro()).isEqualTo(DEFAULT_SUMINISTRO);
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nombre(UPDATED_NOMBRE).socio(UPDATED_SOCIO).suministro(UPDATED_SUMINISTRO).dni(UPDATED_DNI);
        ...
        assertThat(testCliente.getSocio()).isEqualTo(UPDATED_SOCIO);
        assertThat(testCliente.getSuministro()).isEqualTo(UPDATED_SUMINISTRO);
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.suministro(UPDATED_SUMINISTRO);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE).socio(UPDATED_SOCIO).suministro(UPDATED_SUMINISTRO).dni(UPDATED_DNI);
