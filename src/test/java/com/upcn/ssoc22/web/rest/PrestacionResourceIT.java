...
class PrestacionResourceIT {
    ...
    private static final String DEFAULT_CARENCIAS = "AAAAAAAAAA";
    private static final String UPDATED_CARENCIAS = "BBBBBBBBBB";
    ...
    public static Prestacion createEntity(EntityManager em) {
        Prestacion prestacion = new Prestacion().tipo(DEFAULT_TIPO).carencias(DEFAULT_CARENCIAS);
        return prestacion;
    }
    ...
    public static Prestacion createUpdatedEntity(EntityManager em) {
        Prestacion prestacion = new Prestacion().tipo(UPDATED_TIPO).carencias(UPDATED_CARENCIAS);
        return prestacion;
    }
    ...
    void createPrestacion() throws Exception {
        ...
        assertThat(testPrestacion.getCarencias()).isEqualTo(DEFAULT_CARENCIAS);
    }
    ...
    void getAllPrestacions() throws Exception {
        ...
        restPrestacionMockMvc
            ...
            .andExpect(jsonPath("$.[*].carencias").value(hasItem(DEFAULT_CARENCIAS)));
    }
    ...
    void getPrestacion() throws Exception {
        ...
        restPrestacionMockMvc
            ...
            .andExpect(jsonPath("$.carencias").value(DEFAULT_CARENCIAS));
    }
    ...
    void putNewPrestacion() throws Exception {
        ...
        updatedPrestacion.tipo(UPDATED_TIPO).carencias(UPDATED_CARENCIAS);
        ...
        assertThat(testPrestacion.getCarencias()).isEqualTo(UPDATED_CARENCIAS);
    }
    ...
    void partialUpdatePrestacionWithPatch() throws Exception {
        ...
        partialUpdatedPrestacion.tipo(UPDATED_TIPO);
    ...
    void fullUpdatePrestacionWithPatch() throws Exception {
        ...
        partialUpdatedPrestacion.tipo(UPDATED_TIPO).carencias(UPDATED_CARENCIAS);
