...
class PrestadorResourceIT {
    ...
    public static Prestador createEntity(EntityManager em) {
        Prestador prestador = new Prestador().nombre(DEFAULT_NOMBRE).condicion(DEFAULT_CONDICION);
        return prestador;
    }
    ...
    public static Prestador createUpdatedEntity(EntityManager em) {
        Prestador prestador = new Prestador().nombre(UPDATED_NOMBRE).condicion(UPDATED_CONDICION);
        return prestador;
    }
    ...
    void createPrestador() throws Exception {
        ...
        assertThat(testPrestador.getNombre()).isEqualTo(DEFAULT_NOMBRE);
        assertThat(testPrestador.getCondicion()).isEqualTo(DEFAULT_CONDICION);
    }
    ...
    void putNewPrestador() throws Exception {
        ...
        updatedPrestador.nombre(UPDATED_NOMBRE).condicion(UPDATED_CONDICION);
        ...
        Prestador testPrestador = prestadorList.get(prestadorList.size() - 1);
        assertThat(testPrestador.getNombre()).isEqualTo(UPDATED_NOMBRE);
        assertThat(testPrestador.getCondicion()).isEqualTo(UPDATED_CONDICION);
    }
    ...
    void partialUpdatePrestadorWithPatch() throws Exception {
        ...
        partialUpdatedPrestador.nombre(UPDATED_NOMBRE).condicion(UPDATED_CONDICION);
