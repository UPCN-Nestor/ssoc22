...
describe('Prestacion Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call itemNomenclador query and add missing value', () => {
      ...
      const itemNomenclador: IItemNomenclador = { id: 61125 };
      prestacion.itemNomenclador = itemNomenclador;

      const itemNomencladorCollection: IItemNomenclador[] = [{ id: 86894 }];
      jest.spyOn(itemNomencladorService, 'query').mockReturnValue(of(new HttpResponse({ body: itemNomencladorCollection })));
      const expectedCollection: IItemNomenclador[] = [itemNomenclador, ...itemNomencladorCollection];
      ...
      expect(comp.itemNomencladorsCollection).toEqual(expectedCollection);
    });
    ...
    it('Should update editForm', () => {
      const prestacion: IPrestacion = { id: 456 };
      const itemNomenclador: IItemNomenclador = { id: 244 };
      prestacion.itemNomenclador = itemNomenclador;
      ...
      expect(comp.itemNomencladorsCollection).toContain(itemNomenclador);
