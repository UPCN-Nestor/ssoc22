...
export class SolicitudPrestacionService {
  ...
  protected convertDateFromClient(solicitudPrestacion: ISolicitudPrestacion): ISolicitudPrestacion {
    return Object.assign({}, solicitudPrestacion, {
      fecha: solicitudPrestacion.fecha?.isValid() ? solicitudPrestacion.fecha.format(DATE_FORMAT) : undefined,
      horaSolicitud: solicitudPrestacion.horaSolicitud?.isValid() ? solicitudPrestacion.horaSolicitud.format(DATE_FORMAT) : undefined,
    });
  }
