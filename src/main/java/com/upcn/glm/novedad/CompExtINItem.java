 ...
 *         &lt;element name="Fac2ItmOrd" type="{http://www.w3.org/2001/XMLSchema}short"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CompExtIN.Item", propOrder = { "fac1Srv", "fac2Itm", "fac2Imp1", "fac2ItmOrd" })
public class CompExtINItem {
    ...
    @XmlElement(name = "Fac2ItmOrd")
    protected short fac2ItmOrd;
    ...
    /**
     * Obtiene el valor de la propiedad fac2ItmOrd.
     *
     */
    public short getFac2ItmOrd() {
        return fac2ItmOrd;
    }

    /**
     * Define el valor de la propiedad fac2ItmOrd.
     *
     */
    public void setFac2ItmOrd(short value) {
        this.fac2ItmOrd = value;
    }
}
