...
public class PrestadorResource {
    ...
    public List<Prestador> getAllPrestadors(
        ...
        if ("solicitudprestacion-is-null".equals(filter)) {
            log.debug("REST request to get all Prestadors where solicitudPrestacion is null");
            return StreamSupport
                .stream(prestadorRepository.findAll().spliterator(), false)
                .filter(prestador -> prestador.getSolicitudPrestacion() == null)
