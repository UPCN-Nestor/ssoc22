...
/**
 * REST controller for managing {@link com.upcn.ssoc22.domain.Medico}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MedicoResource {
    ...
    public ResponseEntity<Medico> updateMedico(@PathVariable(value = "id", required = false) final Long id, @RequestBody Medico medico)
    ...
    public ResponseEntity<Medico> partialUpdateMedico(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, medico.getId().toString())
        );
    }
