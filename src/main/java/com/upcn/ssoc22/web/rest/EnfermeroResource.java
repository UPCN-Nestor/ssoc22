...
public class EnfermeroResource {
    ...
    public ResponseEntity<Enfermero> updateEnfermero(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, enfermero.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Enfermero> partialUpdateEnfermero(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, enfermero.getId().toString())
        );
    }
