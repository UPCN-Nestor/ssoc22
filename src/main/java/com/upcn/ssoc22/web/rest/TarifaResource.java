...
public class TarifaResource {
    ...
    public ResponseEntity<Tarifa> updateTarifa(@PathVariable(value = "id", required = false) final Long id, @RequestBody Tarifa tarifa)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tarifa.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tarifa> partialUpdateTarifa(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tarifa.getId().toString())
        );
    }
