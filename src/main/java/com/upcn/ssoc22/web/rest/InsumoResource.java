...
public class InsumoResource {
    ...
    public ResponseEntity<Insumo> updateInsumo(@PathVariable(value = "id", required = false) final Long id, @RequestBody Insumo insumo)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, insumo.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Insumo> partialUpdateInsumo(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, insumo.getId().toString())
        );
    }
