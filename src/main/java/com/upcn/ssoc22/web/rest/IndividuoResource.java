...
public class IndividuoResource {
    ...
    public ResponseEntity<Individuo> updateIndividuo(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, individuo.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Individuo> partialUpdateIndividuo(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, individuo.getId().toString())
        );
    }
