    ...
    public ResponseEntity<Adhesion> partialUpdateAdhesion(
        ...
        Optional<Adhesion> result = adhesionRepository
            ...
            .map(existingAdhesion -> {
                if (adhesion.getFecha() != null) {
                    existingAdhesion.setFecha(adhesion.getFecha());
                }
                if (adhesion.getParticularidades() != null) {
                    existingAdhesion.setParticularidades(adhesion.getParticularidades());
                }
