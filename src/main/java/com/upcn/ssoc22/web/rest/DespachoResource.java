...
public class DespachoResource {
    ...
    public ResponseEntity<Despacho> updateDespacho(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, despacho.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Despacho> partialUpdateDespacho(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, despacho.getId().toString())
        );
    }
