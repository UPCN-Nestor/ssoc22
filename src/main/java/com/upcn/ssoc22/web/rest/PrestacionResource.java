...
public class PrestacionResource {
    ...
    public ResponseEntity<Prestacion> updatePrestacion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, prestacion.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Prestacion> partialUpdatePrestacion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, prestacion.getId().toString())
        );
    }
