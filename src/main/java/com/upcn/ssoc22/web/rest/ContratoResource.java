...
/**
 * REST controller for managing {@link com.upcn.ssoc22.domain.Contrato}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ContratoResource {
    ...
    public ResponseEntity<Contrato> partialUpdateContrato(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contrato.getId().toString())
        );
    }
