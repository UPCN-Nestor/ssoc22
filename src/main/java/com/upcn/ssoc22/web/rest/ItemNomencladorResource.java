...
public class ItemNomencladorResource {
    ...
    public ResponseEntity<ItemNomenclador> updateItemNomenclador(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, itemNomenclador.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ItemNomenclador> partialUpdateItemNomenclador(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, itemNomenclador.getId().toString())
        );
    }
