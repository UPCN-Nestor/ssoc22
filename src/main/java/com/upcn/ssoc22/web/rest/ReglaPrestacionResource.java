...
public class ReglaPrestacionResource {
    ...
    public ResponseEntity<ReglaPrestacion> updateReglaPrestacion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reglaPrestacion.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ReglaPrestacion> partialUpdateReglaPrestacion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reglaPrestacion.getId().toString())
        );
    }
