...
public class SolicitudPrestacionResource {
    ...
    public ResponseEntity<SolicitudPrestacion> updateSolicitudPrestacion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, solicitudPrestacion.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SolicitudPrestacion> partialUpdateSolicitudPrestacion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, solicitudPrestacion.getId().toString())
        );
    }
