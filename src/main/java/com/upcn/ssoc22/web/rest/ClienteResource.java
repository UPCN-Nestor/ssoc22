...
/**
 * REST controller for managing {@link com.upcn.ssoc22.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Cliente> result = clienteRepository
            ...
            .map(existingCliente -> {
                ...
                if (cliente.getSocio() != null) {
                    existingCliente.setSocio(cliente.getSocio());
                }
                if (cliente.getSuministro() != null) {
                    existingCliente.setSuministro(cliente.getSuministro());
                }
