...
public class ItemFacturaResource {
    ...
    public ResponseEntity<ItemFactura> updateItemFactura(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, itemFactura.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ItemFactura> partialUpdateItemFactura(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, itemFactura.getId().toString())
        );
    }
