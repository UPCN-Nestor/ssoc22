...
public class Provision implements Serializable {
    ...
    public void setItemNomencladors(Set<ItemNomenclador> itemNomencladors) {
        if (this.itemNomencladors != null) {
            this.itemNomencladors.forEach(i -> i.setProvision(null));
        }
        if (itemNomencladors != null) {
            itemNomencladors.forEach(i -> i.setProvision(this));
        }
        this.itemNomencladors = itemNomencladors;
    }

    public Provision itemNomencladors(Set<ItemNomenclador> itemNomencladors) {
        this.setItemNomencladors(itemNomencladors);
        return this;
    }

    public Provision addItemNomenclador(ItemNomenclador itemNomenclador) {
        this.itemNomencladors.add(itemNomenclador);
        itemNomenclador.setProvision(this);
        return this;
    }

    public Provision removeItemNomenclador(ItemNomenclador itemNomenclador) {
        this.itemNomencladors.remove(itemNomenclador);
        itemNomenclador.setProvision(null);
        return this;
    }
