...
public class Movil implements Serializable {
    ...
    public void setDespachos(Set<Despacho> despachos) {
        if (this.despachos != null) {
            this.despachos.forEach(i -> i.removeMovil(this));
        }
        if (despachos != null) {
            despachos.forEach(i -> i.addMovil(this));
        }
