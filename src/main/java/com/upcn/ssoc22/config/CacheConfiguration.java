...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.upcn.ssoc22.domain.Despacho.class.getName() + ".chofers");
            createCache(cm, com.upcn.ssoc22.domain.Despacho.class.getName() + ".medicos");
            createCache(cm, com.upcn.ssoc22.domain.Despacho.class.getName() + ".enfermeros");
            createCache(cm, com.upcn.ssoc22.domain.Despacho.class.getName() + ".movils");
            ...
            createCache(cm, com.upcn.ssoc22.domain.Prestador.class.getName() + ".solicitudPrestacions");
