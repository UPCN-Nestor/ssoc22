...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.upcn.ssoc22.domain.Cliente.class.getName() + ".subscripcions");
            ...
            createCache(cm, com.upcn.ssoc22.domain.Subscripcion.class.getName());
            createCache(cm, com.upcn.ssoc22.domain.Plan.class.getName());
            createCache(cm, com.upcn.ssoc22.domain.Plan.class.getName() + ".reglaPrestacions");
            createCache(cm, com.upcn.ssoc22.domain.Plan.class.getName() + ".excepcionInsumos");
            createCache(cm, com.upcn.ssoc22.domain.Plan.class.getName() + ".subscripcions");
            ...
            createCache(cm, com.upcn.ssoc22.domain.Prestacion.class.getName() + ".reglaPrestacions");
            createCache(cm, com.upcn.ssoc22.domain.Prestacion.class.getName() + ".solicitudPrestacions");
            ...
            createCache(cm, com.upcn.ssoc22.domain.Insumo.class.getName() + ".plans");
            ...
            createCache(cm, com.upcn.ssoc22.domain.Equipo.class.getName());
            createCache(cm, com.upcn.ssoc22.domain.Equipo.class.getName() + ".despachos");
